                    ...
                    <nav class="sidebar-nav left-sidebar-menu-pro">
                        <ul class="metismenu" id="menu1">
                            <li class="active">
                              ...
                              <li class="b-inner">
                                <a href="Attendence.aspx"><i class="fa fa-graduation-cap"></i>&nbsp;&nbsp; Attendence</a>                              
                            </li>
                                
                            <li class="a-inner" > <a><i class="fa fa-caret-square-o-right i-class" ></i><span class="inner-span" > Add Attedence</span></a> </li>
                            
                                   <li class="a-inner" > <a><i class="fa fa-caret-square-o-right text-right i-class"></i>
                                       <span class="inner-span"> View Attedence</span> </a> </li>
