...
<asp:Content ID="Content1" ContentPlaceHolderID="contentSide" Runat="Server">
                        ...
                        <ul class="metismenu" id="menu1">
                           ...
                           <li class="b-inner">
                                <a href="../Class.aspx" aria-expanded="false" ><i class="fa fa-university"></i><span class="mini-click-non">&nbsp;&nbsp; Class</span></a>                               
                                   ...
                                   <li class="a-inner" style="display:table-row"> <a href="#" class="a-inner-middle" style="display:table-cell;
   vertical-align:middle;"> <i class="fa fa-caret-square-o-right" style="font-size:14px"></i> <span class="inner-span"> Manage Classes </span></a> </li>
                                   ...
                                   <li class="a-inner" style="display:table-row"> <a style="display:table-cell;
   vertical-align:middle;" href="../ViewClass.aspx" class="a-inner-middle"> <i class="fa fa-caret-square-o-right" style="font-size:14px"></i> <span class="inner-span">View Class</span></a> </li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentbody" Runat="Server">
    ...
    <%--<div class="review-tab-pro-inner" style="background-color:purple">--%>
                              
                                <%--<div id="myTabContent" class="tab-content custom-product-edit" style="background-color:orange">--%>
                                  <%--  <div class="product-tab-list tab-pane fade active in" id="description" style="background-color:coral">--%>
                                        <%--<div class="row" style="background-color:brown">--%>
                                            <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12" style="background-color:red" >
                                                <asp:Label ID="lblSuccess" runat="server" ForeColor="Green" Text="test"></asp:Label>
                                              
                                                <fieldset>
                                                    <legend>Manage Classes</legend>
                                                
                                                <div class="review-content-section" style="width:500px; background-color:blue">
                    
                                                    
                               <div class="input-group mg-b-pro-edt" style="background-color:orange">                                                                                                 <asp:DropDownList ID="ddlDepartments" runat="server" class="form-control" Width="330px" OnSelectedIndexChanged="ddlDepartments_SelectedIndexChanged" >
            ...
            <asp:ListItem Value="5">Higher</asp:ListItem>           
                                                ...
                                                <br />
                                                        ...
                                                        <div class="form-group review-pro-edt" style="margin-left:13px">
