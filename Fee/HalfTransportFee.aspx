<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="HalfTransportFee.aspx.cs" Inherits="HalfTransportFee" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentDisplay" Runat="Server">
    ...
    <div style="padding: 15px;">
        <asp:Label ID="Label1" Visible="false" runat="server" CssClass="col-md-12 center-block text-center alert-success" />
        <asp:Label ID="Label2" Visible="false" runat="server" CssClass="col-md-12 center-block text-center alert-danger" />
    </div>
                ...
                <div class="col-md-12">
                        ...
                        <fieldset>
                            ...
                            <div class="review-content-section">
                                ...
                                <div class="input-group review-pro-edt" runat="server" id="NameDiv" visible="false">
                                    <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                                    <asp:DropDownList CssClass="form-control"  ID="ddlmonth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlmonth_SelectedIndexChanged">
                               ...
                               <asp:ListItem Value="2">March</asp:ListItem>  
                                <asp:ListItem Value="1">November</asp:ListItem> 
                                 ...
                                 <div class="input-group review-pro-edt" runat="server" id="Div1" visible="false">
                                    <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                                 <asp:DropDownList ID="ddlFeeHeads" DataTextField="FHName" DataValueField="FHID" OnSelectedIndexChanged="ddlFeeHeads_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control" runat="server">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                         ...
                         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="table table-bordered">
                              ...
                              <asp:BoundField HeaderText="Student ID" DataField="StudentCode" />
                              <asp:BoundField HeaderText="Month" DataField="FeeMonth" />
                             <asp:TemplateField HeaderText="Fee Rate" Visible="TRUE">
                                        <ItemTemplate>
                                            <asp:Label ID="txtActualrate" Text='<%#Eval("FeeRate") %>' runat="server"  ></asp:Label>                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     
                                 
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:CheckBox Text="Select All" ID="chkAll" OnCheckedChanged="chkAll_CheckedChanged" AutoPostBack="true" Checked="false" runat="server" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                ...
                                <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtStudentid" runat="server" Text='<%#Eval("StudentId") %>' CssClass="form-control" Visible="false"></asp:TextBox>                                        </ItemTemplate>
                                    </asp:TemplateField>
