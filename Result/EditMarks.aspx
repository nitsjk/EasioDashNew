<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="EditMarks.aspx.cs" Inherits="Result_EditMarks" %>
    ...
    <div class="left-custom-menu-adp-wrap comment-scrollbar">
        ...
        <nav class="sidebar-nav left-sidebar-menu-pro">
            <ul class="metismenu" id="menu1">
                ...
                <li class="a-inner" style="display: table-row"><a href="EditMarks.aspx" class="a-inner-middle" style="display: table-cell; vertical-align: middle;"><i class="fa fa-caret-square-o-right" style="font-size: 14px"></i><span class="inner-span"> Edit Marks </span></a></li>
            </ul>
        </nav>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentDisplay" Runat="Server">
    <div class="col-md-12 center-block text-center" style="margin-top: 40px;">
    ...
    <div class="row" >
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-top: 25px;">
            ...
            <asp:GridView runat="server" ID="gvEditMarks" AutoGenerateColumns="False" CssClass="table table-striped" CellPadding="2" Width="100%" RowStyle-Wrap="false" ForeColor="White"  GridLines="None" CellSpacing="2" HeaderStyle-CssClass="GridHeader" HeaderStyle-HorizontalAlign="Center">       
                ...
                <Columns>
                     ...
                     <asp:TemplateField HeaderText="Roll No" HeaderStyle-CssClass="GridHeader" >
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblStudentId" Text= '<%# Eval("studentID") %>' runat="server" Visible="false" />
            ...
            <asp:Button Text="Update" runat="server" ID="btnUpdate" CssClass="btn btn-primary" ValidationGroup="val" Visible="false" OnClick="btnUpdate_Click" />
        </div>
