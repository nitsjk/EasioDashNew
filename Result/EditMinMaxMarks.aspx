     ...
     <%--   <div>
        ...
        <nav class="sidebar-nav left-sidebar-menu-pro">
            <ul class="metismenu2" id="menu1">
                ...
                <li class="a-inner" style="display: table-row"><a href="EditAward.aspx" class="a-inner-middle" style="display: table-cell; vertical-align: middle;"><i class="fa fa-circle-o" style="font-size: 9px"></i><span class="inner-span">&nbsp Edit Award </span></a></li>s
