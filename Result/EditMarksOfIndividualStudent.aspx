<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="EditMarksOfIndividualStudent.aspx.cs" Inherits="Result_EditMarksOfIndividualStudent" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentDisplay" Runat="Server">
    ...
    <div class="row" >
        ...
        <fieldset style="height:35%; margin-left:20px">
            ...
            <div class="review-content-section">
                ...
                <div class="input-group mg-b-pro-edt">
                    <asp:RadioButtonList ID="rbtnSubject" RepeatDirection="Horizontal" runat="server"
                         AutoPostBack="true" OnSelectedIndexChanged="rbtnSubject_SelectedIndexChanged">
                ...
                <div class="input-group mg-b-pro-edt" style="margin-top: -10px">
                    <asp:DropDownList ID="ddlType" DataTextField="unitName" DataValueField="unitid" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlType_SelectedIndexChanged" class="form-control" Width="330px" >                       
                    </asp:DropDownList>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 " style="margin-top: 25px;">
            ...
            <asp:GridView runat="server" ID="gvEditMarks" AutoGenerateColumns="False" CssClass="table table-striped" CellPadding="2" Width="80%" RowStyle-Wrap="false" ForeColor="White"  GridLines="None" CellSpacing="2" HeaderStyle-CssClass="GridHeader" HeaderStyle-HorizontalAlign="Center">       
