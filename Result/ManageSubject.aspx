<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="ManageSubject.aspx.cs" Inherits="Subject_addSubject" %>
    ...
    <div class="left-custom-menu-adp-wrap comment-scrollbar">
        ...
        <nav class="sidebar-nav left-sidebar-menu-pro">
            <ul class="metismenu2" id="menu1">
                ...
                <li class="a-inner" style="display: table-row"><a href="ManageSubject.aspx" class="a-inner-middle" style="display: table-cell; vertical-align: middle;"><i class="fa fa-circle-o" style="font-size:9px"></i><span class="inner-span">&nbsp
        ...
        <fieldset>
            ...
            <div class="review-content-section">
                ...
                <div class="input-group mg-b-pro-edt">
                    ...
                    <asp:TextBox ID="txtSubject" runat="server" CssClass="form-control" ForeColor="Black" Width="290px" placeholder="Enter Subject"></asp:TextBox>
                    
                    <asp:RequiredFieldValidator ErrorMessage="*" Font-Size="Larger" ControlToValidate="txtSubject" runat="server" ValidationGroup="val" ForeColor="Red"></asp:RequiredFieldValidator>
