<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="TimeTable.aspx.cs" Inherits="TimeTable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentSide" Runat="Server">
      ...
      <div class="left-custom-menu-adp-wrap comment-scrollbar">
                    ...
                    <li><a class="has-arrow" title="Landing Page" href="TimeTable.aspx" aria-expanded="false"><i class="fa fa-calendar" aria-hidden="true"></i><span class="mini-click-non">&nbsp;&nbsp; Time-Table</span></a>
